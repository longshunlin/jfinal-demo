...
!function (window) {
    ...
    Tab.prototype.open = function (index) {
        ...
        if ($curNav.hasClass(_this.options.activeClass))return;
...
!function (window) {
    ...
    CitySelect.prototype.open = function () {
        ...
        $cityElement.prev('searchBarBox').addClass('brouce-in');
    ...
    CitySelect.prototype.createDOM = function () {
        ...
        _this.$cityElement = $('' +
            '<div class="searchBarBox">'+
              '<div class="searchBar">'+
               ...
               '<input type="text" class="searchInput" placeholder="'+ _this.defaultSet.txt +'">'+
        ...
        _this.$cityElement.on('click.ydui.cityselect', '.city', function () {
            var $this = $(this);
            if($('.m-cityselect').is(':hidden')){
               $('.city').removeClass('close')
               $('.m-cityselect').removeClass('brouce-in').addClass('brouce-in')
               $('.arrow-up').show()
            }else{
                $('.city').removeClass('close').addClass('close')
