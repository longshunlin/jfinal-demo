...
(function () {
    ...
    var iframeUrlMap = {
        ...
        'inserttable':'~/dialogs/table/table.jsp',
        'link':'~/dialogs/link/link.jsp',
        'spechars':'~/dialogs/spechars/spechars.jsp',
        'searchreplace':'~/dialogs/searchreplace/searchreplace.jsp',
        'map':'~/dialogs/map/map.jsp',
        'gmap':'~/dialogs/gmap/gmap.jsp',
        'insertvideo':'~/dialogs/video/video.jsp',
        'help':'~/dialogs/help/help.jsp',
        'highlightcode':'~/dialogs/highlightcode/highlightcode.jsp',
        'emotion':'~/dialogs/emotion/emotion.jsp',
        'wordimage':'~/dialogs/wordimage/wordimage.jsp',
        'attachment':'~/dialogs/attachment/attachment.jsp',
        'insertframe':'~/dialogs/insertframe/insertframe.jsp',
        'edittd':'~/dialogs/table/edittd.jsp',
        'webapp':'~/dialogs/webapp/webapp.jsp',
        'snapscreen':'~/dialogs/snapscreen/snapscreen.jsp',
        'scrawl':'~/dialogs/scrawl/scrawl.jsp',
        'music':'~/dialogs/music/music.jsp',
        'template':'~/dialogs/template/template.jsp',
        'background':'~/dialogs/background/background.jsp'
    };
